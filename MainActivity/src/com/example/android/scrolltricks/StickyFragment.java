...
public class StickyFragment extends Fragment implements ObservableScrollView.Callbacks {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        top_view = (TextView) rootView.findViewById(R.id.top_view);
    ...
    public void onScrollChanged(int scrollY) {
        Log.e("top:", mPlaceholderView.getTop()+"");
        Log.e("scrollT", scrollY+"");
        top_view.setTranslationY(scrollY);
        if(scrollY==0)
        linear_layout.setTranslationY(top_view.getHeight());
        mStickyView.setTranslationY(Math.max(mPlaceholderView.getTop()+top_view.getHeight(), scrollY));
